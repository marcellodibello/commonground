...
the person---their inability to communicate---or we could look 
...
individuals who belong to any minoritized group.^[Can you think of other examples, say involving race? What are analogies and differences?]
...
and wide-ranging. So hermeneutical injustice can be *systemic* or *incidental*.^[An example of incidental hermeneutical injustice is Joe's case on pp. 156-157.] Only systemic hermeneutical injustice correlates 
...
In addition, there are also secondary practical harms. 
...
if one is not understood, one can start losing epistemic confidence 
...
interpretative maxim along the lines: think what the speaker would be saying in an environment 

...
of *cheap* common ground. 


(a) `r tufte::newthought('First')`: Stalnaker's two definitions
...
*jointly accept* $p$.^[Stalnaker (2014), *Context*, Oxford University Press.]
...
Why care about the common ground? 
...
Suppose one is an internationalist about meaning (like Grice, Stalnaker).^[An intentionalist about (linguistic) meaning holds what a speaker means by an utterance $U$ comes down to facts about what the speakers intends to do with $U$.]
Could any string of sounds mean 
anything so long as such anything is the speaker's *intended* meaning?
...
what I intend to mean with the sound "blerg blerg"?^[I cannot possibly mean [your paper is due tomorrow] with the sound "blerg blerg" if I am in my right mind. But why not, exactly, if intentionalism about meaning holds? This is the Humpty Dumpty problem.] 
...
exploiting the mechanism of accommodation.

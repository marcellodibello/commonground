...
> The hard questions concern whether we shoud trust observation more or less than other sources of belief in specific context...the hard cases concern what I have called *comparative* fundamental principles. (p.77)^[So, if neither tradition nor an appeal to common sense are an adequate response to skepticism, what do we do? We are left empty-handed. Lynch in his book has an answer. If you are curious, read chapters 5 and 6.]

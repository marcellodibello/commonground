...
(i) each agent assigns an *inherent* preference score, say between 0 and 10, to moral rules $R_i$'s, where the score is inherent in the sense that it does not take into account whether other agents share the same assessment for the rule in question (denote this by $\mu_A(R_i)$, with $A$ the agent in question and $R_i$ the given moral rule);
...
Agents are randomly assigned one of the four weighing types. 

...
They all place blame, to different degrees, on individualism and loss of community. These explanations are not meant to be exhaustive or definitive, but simply a starting point for the conversation. We will return back to them throughout the course. The more specific philosophical readings that follow about questions of language, logic and reasoning, rational inquiry and political deliberation can all be situated within these overarching explanations. 

*Essential readings*

- Rodgers (2011), The Rediscovery of the Market (Chapter 2 of [The Age of Fracture](https://www.hup.harvard.edu/catalog.php?isbn=9780674064362)) - *Check Canvas for pdf*

- Deneen (2018), The Degradation of Citizenship (Chapter 7 of [Why Liberalism Failed](https://yalebooks.yale.edu/book/9780300240023/why-liberalism-failed/))  - *Check Canvas for pdf*

- McGhee (2021), Racism Drained the Pool (Chapter 2 of [The Sum of Us](https://www.penguinrandomhouse.com/books/564989/the-sum-of-us-by-heather-mcghee/))  - *Check Canvas for pdf*
...
- Lynch (2012), Nothing by Dreams and Smoke and Reasons Ends: Tradition and Common Sense (Chapters 3 and 4 of [In Praise of Reasons](https://mitpress.mit.edu/9780262526050/in-praise-of-reason/))  
...
The challenge of skepticism remains unanswered, but we can set it aside. 
...
Let us assume---somewhat optimistically---that people are often engaged in an empirically-informed rational inquiry, share a conception of what counts as evidence for a claim and criteria to assess the strength of this evidence. <!---So long as this epistemological common ground exists and the inquirers share the same evidence, we should hope that no irredeemable disagreement can emerge. But a lot depends on what we mean by "sharing the same evidence". While two people might share the same "brute" evidence---say, they have access to the same data, documents, readings, etc.---they might interpret it differently. Or the same evidence might be ambiguous and thus invite different interpretations. --->
But, perhaps surprisingly, even people who share the same evidence and share the same standards for assessing the evidence might end up endorsing radically different positions---a phenomenon that has been called "rational polarization". How widespread or worried we should be about this phenomenon is another matter. Is rational polarization the most plausible explanation for widespread polarization? This is hard to say, but there is empirical evidence that rational polarization plays an important role in explaining actual belief polarization. 
...
- Fricker (2007), Hermeneutical Injustice (Chapter 7 of [Epistemic Injustice](https://academic.oup.com/book/32817)) - *Check Canvas for pdf*
...
worth exploring here. First, an individualistic, competition-driven market logic that extents everywhere end up pitting people against each another.  Second, political deliberations are inherently conflictual: friendship can exist only 
...
- 
Mouffe (1993), Politics and the Limits of Liberalism (Chapter 7 of [The Return of the Political](https://www.versobooks.com/books/3145-the-return-of-the-political))


*Additional readings and materials*


- Schmitt, The Concept of the Political (in [The Concept of the Political](https://press.uchicago.edu/ucp/books/book/chicago/C/bo5458073.html))

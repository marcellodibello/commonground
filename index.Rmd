...
---
title: "PHI 420/591 Common Ground"
subtitle: "Spring 23"
...
The readings in this course are organized systemically to cover different areas of philosophy.  The need for a common ground can manifest itself in different areas of human engagement. We will focus on four in particular: communication, reasoning, rational inquiry about the world, and political deliberation. These four areas fall (roughly) within the purview of four sub-disciplines of philosophy: philosophy of language; logic and argumentation theory;  epistemology and philosophy of science; and finally, value theory, including moral, social and political philosophy. To these four, we will add a fifth area of investigation, what we might call the question of inclusion and belonging. 

In this first class meeting, however, we will read beyond philosophy. We will 
consider a family of explanations for why our society is divided and polarized, focusing on the logic of market capitalism, the principles of liberal democracy, the legacy of racism.
They all trace division and polarization  to excessive individualism and loss of community. These explanations are not meant to be exhaustive or definitive, but simply a starting point for the conversation. We can return back to them throughout the course. The more specific philosophical readings that follow about questions of language, logic and reasoning, rational inquiry and political deliberation can all be situated within these overarching explanations. 
...
- Deneen (2018), The Degradation of Citizenship (Chapter 7 of [Why Liberalism Failed](https://yalebooks.yale.edu/book/9780300240023/why-liberalism-failed/))

- McGhee (2021), Racism Drained the Pool (Chapter 2 of [The Sum of Us](https://www.penguinrandomhouse.com/books/564989/the-sum-of-us-by-heather-mcghee/))
...
There are many forms of incommensurability: one's language can be incommensurable relative to another, that, is, it is impossible to carry out a meaning-preserving translation from one language to another; one's system of concepts can be incommensurable to another; one's system of values and morals can be incommensurable to another; etc. We will focus primarily on linguistic and conceptual incommensurability. 
...
- van Eemeren (2003), Rules for a Critical Discussion (Chapter 6 of A Systematic Theory of Argumentation) - *Check Canvas for pdf*
...
So, the common ground, from an epistemological perspective, seems to be that we should be responsive to evidence if we aim to figure out what the world is like. But what does it mean to be 'responsive to evidence'? And why should we be responsive to evidence in the first place?

Being responsive to evidence will likely include a set of epistemic rules and practices, such as follow the deliverance of the senses; perform experiments in such-and-such a way; and so.  The problem, however, is that whatever these epistemic rules and practices are, it would be hard to justify them in a non-circular way. This is the skeptical challenge. We might insist that common epistemic rules and practices are truth conducive. 
In fact, scientists have suggested---albeit perhaps in an exaggerated manner---that common rules and practices used to gather, analyze and  draw inferences from evidence lead to falsehoods rather than truths. And even if these claims are an exaggeration, the skeptical doubt remains.  For how can we argue that being evidence-responsive is truth-conducive without, in a circular manner, appeal to evidence? 
...
Another explanation for belief polarization is that---because of the structure of information cascading on social media---people will have selective access to information and inhabit epistemic bubbles and echo chambers (though we will see that the two are different). Echo chambers and bubbles are failures of common ground---not in the sense that people do not share the principles of logic or reasoning---but in the sense that people do not share the same evidence. Given these circumstances, then, belief polarization is quite inevitable, and in many ways, entirely unsurprising. The cure, then, is simple: escape your epistemic bubble and eco chamber; go talk to those with whom you disagree; etc. As we will see, though, it is much harder to escape an echo chamber than an epistemic bubble. 

*Essential readings*

- Nguyen, [Eco Chambers and Epistemic Bubbles](https://www.marcellodibello.com/commonground/readings/ChambersBubbles.pdf)
...
Epistemic bubbles and echo chambers are ecosystems of information, with their own interval rules and regulations. They constitute, in some sense, a common ground, at least for those who are part of them. A common ground, then, can also exclude, and perhaps it needs to exclude in order to include. So what happens when some people---along with their knowledge, evidence, testimony, experience---are excluded? Recently, a number of philosophers within the analytic tradition have theorized about "epistemic injustice", which takes various forms: testimonial, hermeneutical, oppressive. Long before these discussions in analytic philosophy, one of the foundational texts of post-colonial theory took up the question whether certain voices are systematically excluded from the conversation---and cannot even articulate their position. 

*Essential readings:*

- Fricker (2007), Hermenautical Injustice (Chapter 7 of [Epistemic Injustice](https://academic.oup.com/book/32817)) - *Check Canvas for pdf*
...
- Rawls (1992), The Idea of an Overlapping Consensus and The Idea of Public Reason (lectures IV and IV of [Political Liberalism](http://cup.columbia.edu/book/political-liberalism/9780231130899)) - *Check Canvas for pdf*

- Quong (2010), Unreasonable Citizens (Chapter 10 of [Liberalism without Perfection](https://academic.oup.com/book/12006)) - *Check Canvas for pdf*
...
Besides the more radical critiques, if we still think that the ideal of an overlapping consensus and public reason are good ones---we might not---the question is how to regain a functioning public reasoning via surgical interventions. One proposal focuses on reestablishing trust, between people of opposing views and between citizens and public institutions. Another proposal emphasize the virtue of civility. Both proposals underscore
that attitudes toward each other---not an agreement about content---are essential for a functioning public reason. 

*Essential readings*

- Vallier (2019), Moral Piece and Social Trust and Public Justification (Chapter 1 and 3 of [Must Politics Be War](https://academic.oup.com/book/8276)?)
